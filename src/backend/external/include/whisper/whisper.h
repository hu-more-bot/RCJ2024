...
whisper_init_from_buffer_with_params(void *buffer, size_t buffer_size,
                                     struct whisper_context_params params);
WHISPER_API struct whisper_context *
whisper_init_with_params(struct whisper_model_loader *loader,
                         struct whisper_context_params params);
...
WHISPER_API struct whisper_context *whisper_init_from_file_with_params_no_state(
...
WHISPER_API struct whisper_context *
whisper_init_with_params_no_state(struct whisper_model_loader *loader,
                                  struct whisper_context_params params);

WHISPER_DEPRECATED(WHISPER_API struct whisper_context *whisper_init_from_file(
                       const char *path_model),
                   "use whisper_init_from_file_with_params instead");
WHISPER_DEPRECATED(WHISPER_API struct whisper_context *whisper_init_from_buffer(
                       void *buffer, size_t buffer_size),
                   "use whisper_init_from_buffer_with_params instead");
WHISPER_DEPRECATED(WHISPER_API struct whisper_context *whisper_init(
                       struct whisper_model_loader *loader),
                   "use whisper_init_with_params instead");
WHISPER_DEPRECATED(WHISPER_API struct whisper_context
                       *whisper_init_from_file_no_state(const char *path_model),
                   "use whisper_init_from_file_with_params_no_state instead");
WHISPER_DEPRECATED(WHISPER_API struct whisper_context
                       *whisper_init_from_buffer_no_state(void *buffer,
                                                          size_t buffer_size),
                   "use whisper_init_from_buffer_with_params_no_state instead");
WHISPER_DEPRECATED(WHISPER_API struct whisper_context *whisper_init_no_state(
                       struct whisper_model_loader *loader),
...
WHISPER_API void
whisper_free_context_params(struct whisper_context_params *params);
...
// Return the short string of the specified language name (e.g. 2 -> "german"),
// returns nullptr if not found
...
struct whisper_full_params {
  ...
  bool print_realtime; // print results from within whisper.cpp (avoid it, use
                       // callback instead)
  bool print_timestamps; // print timestamps for each text segment when printing
                         // realtime
...
// caller to free the pointer - see whisper_free_context_params &
// whisper_free_params()
...
WHISPER_API void whisper_log_set(ggml_log_callback log_callback,
                                 void *user_data);
